...
EXERCISES = [
    {
        ...
        "instructions": "Sit in a chair with feet flat on the floor. "
                        "Slowly lift toes toward your shin, hold 2 seconds, then point toes down. "
                        "Perform slowly and with control. Rest 30 seconds between sets.",
        "icon": "🦶",
        "lottie": "https://lottie.host/5e8e7e3e-c7e7-4a5a-9a5e-2e7e7e7e7e7e/ankle-pump.lottie",
        "lottie_fallback": "https://assets5.lottiefiles.com/packages/lf20_hs2gxjks.json",
    },
    {
        "name": "Knee Slides",
        ...
        "instructions": "Lie on your back on the bed. Slowly slide one heel toward your bottom, "
                        "bending the knee. Hold for 3 seconds, then slide back. "
                        "Repeat on both sides. Keep movements slow and controlled.",
        "icon": "🦵",
        "lottie": "https://assets9.lottiefiles.com/packages/lf20_xvmprwis.json",
        "lottie_fallback": "https://assets9.lottiefiles.com/packages/lf20_xvmprwis.json",
    },
    {
        ...
        "instructions": "Stand holding a stable surface (table or chair back). "
                        "Slowly shift your weight onto your affected leg, hold 3 seconds, "
                        "then shift back. Keep both feet on the floor throughout.",
        "icon": "⚖️",
        "lottie": "https://assets3.lottiefiles.com/packages/lf20_ttvteyvs.json",
        "lottie_fallback": "https://assets3.lottiefiles.com/packages/lf20_ttvteyvs.json",
    },
    {
        ...
        "instructions": "Sit upright in a sturdy chair. Slowly lift one knee up, "
                        "then lower and lift the other — like marching in place. "
                        "Keep your back straight and breathe steadily.",
        "icon": "🚶",
        "lottie": "https://assets4.lottiefiles.com/packages/lf20_yjgxhvio.json",
        "lottie_fallback": "https://assets4.lottiefiles.com/packages/lf20_yjgxhvio.json",
    },
    {
        "name": "Ankle Circles",
        ...
        "instructions": "Sit in a chair with feet lifted slightly off the floor. "
                        "Rotate each ankle slowly in large circles — 10 clockwise, 10 anti-clockwise. "
                        "This is excellent for reducing morning stiffness.",
        "icon": "🔄",
        "lottie": "https://assets2.lottiefiles.com/packages/lf20_bbwdmbsw.json",
        "lottie_fallback": "https://assets2.lottiefiles.com/packages/lf20_bbwdmbsw.json",
    },
    {
        "name": "Wall Push-Ups",
        "reps": "10 reps × 3 sets",
        ...
        "instructions": "Stand arm's length from a wall. Place both hands flat on the wall "
                        "at shoulder height. Slowly bend elbows to bring chest toward wall, "
                        "hold 2 seconds, then push back. Focus on the affected arm doing equal work.",
        "icon": "🤸",
        "lottie": "https://assets6.lottiefiles.com/packages/lf20_v4uxzslt.json",
        "lottie_fallback": "https://assets6.lottiefiles.com/packages/lf20_v4uxzslt.json",
    },
    {
        "name": "Calf Raises",
        "reps": "10 reps × 2 sets",
        ...
        "instructions": "Stand holding a chair back for support. Slowly rise up onto your toes, "
                        "hold 2–3 seconds, then lower slowly. The slow lowering phase is crucial. "
                        "If the affected leg is too weak, lead with the stronger leg.",
        "icon": "🏋️",
        "lottie": "https://assets8.lottiefiles.com/packages/lf20_uwR49r.json",
        "lottie_fallback": "https://assets8.lottiefiles.com/packages/lf20_uwR49r.json",
    },
    {
        ...
        "instructions": "Sit or lie comfortably. Breathe in slowly through nose for 4 counts, "
                        "hold for 2 counts, breathe out through mouth for 6 counts. "
                        "This activates the parasympathetic nervous system and helps reduce blood pressure.",
        "icon": "🧘",
        "lottie": "https://assets1.lottiefiles.com/packages/lf20_wnqlfojb.json",
        "lottie_fallback": "https://assets1.lottiefiles.com/packages/lf20_wnqlfojb.json",
    },
]
